    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed inset-x-0 bottom-0 z-40 border-t border-white/10 bg-navy/95 pb-[env(safe-area-inset-bottom)] backdrop-blur"
        >
          <div className="mx-auto flex w-full max-w-content items-center justify-between gap-4 px-5 py-3.5 sm:px-8 lg:px-10">
            <div className="flex min-w-0 items-center gap-3">
              <span
                aria-hidden="true"
                className="hidden h-8 w-1 shrink-0 rounded-full bg-gold sm:block"
              />
            ...
            <button
              ...
              className="btn-primary shrink-0 whitespace-nowrap px-4 py-2.5 text-[11px] sm:px-6 sm:text-sm"
            >
